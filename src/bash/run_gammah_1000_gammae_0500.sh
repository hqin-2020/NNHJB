...
#SBATCH --job-name=run_gammah_1000_gammae_0500
#SBATCH --output=./job-outs/run_gammah_1000_gammae_0500.out
#SBATCH --error=./job-outs/run_gammah_1000_gammae_0500.err
